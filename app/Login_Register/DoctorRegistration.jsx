...
function DoctroRegistera({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.customer}>
        ...
        >
          <Button color="#ff4468" title="Doctor Registration" />
        </TouchableOpacity>
      </View>
      <TextInput
        placeholder="Email"
      ...
      <View style={styles.registerButton}>
        <Button
          color="#ff4468"
          title="Login"
          onPress={() => router.push("Login_Register/DoctorLogin")}
        />
      </View>
    </View>
  );
...
export default DoctroRegistera;
