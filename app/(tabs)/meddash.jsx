        ...
        <View>
          ...
          <TouchableOpacity onPress={ToggleSwipe} style={styles.calendarToggle}>
            <Text style={styles.calendarToggleText}>
              {isSwipeVisible
                ? "Hide Today's Medications ▲"
                : "Show Medication Calendar ▼"}
            </Text>
          </TouchableOpacity>

          {isSwipeVisible && (
            <View
              style={{ right: 10, height: 300, width: 300, marginBottom: 20 }}
            >
              <Swiper
                cards={swipeMeds}
                renderCard={(med) => (
            ...
            <View style={styles.modalContainer}>
              <View style={styles.modalContent}>
                <Text style={styles.modalText}>
                  {selectedMed
                    ? `${selectedMed.name} - ${selectedMed.dosage} (${selectedMed.timing})`
            ...
            <View style={styles.medicationItem}>
              ...
              >
                <Text style={styles.medText}>
                  {item.name} - {item.dosage} ({item.timing})
                </Text>
              </TouchableOpacity>
